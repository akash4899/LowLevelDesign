...
class AuctionSystemDemo:
    ...
    def run():
        ...
        auction_system.add_user(user1)
        auction_system.add_user(user2)
        ...
        auction_system.add_listing(listing1)
        auction_system.add_listing(listing2)

        # Search auction listings
        search_results = auction_system.search_auction_listing("Item")
